...
export const TOILET = {
  /** Litres of waste a staff member's toilet visit adds to the shared tank.
   *  Guests instead pass exactly the beer they drank (1 L per beer); staff don't
   *  drink beer, so they get this small fixed amount. */
  staffWastePerUse: 2,
